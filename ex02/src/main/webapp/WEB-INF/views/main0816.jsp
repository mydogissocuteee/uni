...
<head>
    ...
    <!-- css -->
    <link rel="stylesheet" href="./resources/css/0816/product.css" type="text/css">
    <link rel="stylesheet" href="./resources/css/0816/customer.css" type="text/css">
    <link rel="stylesheet" href="./resources/css/0816/goods.css" type="text/css">
    <link rel="stylesheet" href="./resources/css/0816/main.css" type="text/css">
    <link rel="stylesheet" href="./resources/css/0816/user.css" type="text/css">
    <link rel="stylesheet" href="./resources/css/0816/login.css" type="text/css">
    <link rel="stylesheet" href="./resources/css/0816/Fin_product.css" type="text/css">
    ...
    <nav class="sidebar" id="scrollBar">
        <ul>
            <li class="active">
                ...
                <ul class="one-show">
                    <li><a href="#" id="user_li">사용자관리</a></li>
      ...
      <article class="choice-table">
        ...
        <table class="table table-boardered">
          <tr>
              ...
              <td class="col-user1" style="border-left: 1px solid #E6E6E6; border-bottom: 1px solid #E6E6E6;">사용여부</td>
          </tr>
          <tr>
              <td class="num">1</td>
              <td class="col-user2">부서</td>
              <td class="col-user3"><input type="checkbox"></td>
          </tr>
          <tr>
              <td class="num">2</td>
          ...
          <tr>
            <td class="num">7</td>
            <td class="col-user2">시프트</th>
            <td class="col-user3"><input type="checkbox"></td>       
          </tr>
          <tr>
            <td class="num">8</td>
            <td class="col-user2">검사기준 대분류</td>
            <td class="col-user3"><input type="checkbox"></td>    
          </tr>
          <tr>
            <td class="num">9</td>
            <td class="col-user2">검사기준 중분류</td>
            <td class="col-user3"><input type="checkbox"></td>    
          </tr>     
          <tr>
            <td class="num">10</td>
            <td class="col-user2">검사기준 소분류</td>
            <td class="col-user3"><input type="checkbox"></td>    
          </tr>     
          <tr>
            <td class="num">11</td>
...
<div class="produc_ad">
  <table class="user_tb">
    ...
    <tr class="tb_tr"><td  colspan="13"></td></tr>
    <tr class="tb_tr"><td  colspan="13"></td></tr>
  </table>
</div>
<div class="btn">
  ...
  <script type="text/javascript">
	...
	$('#submit-customer').click(function() {
		$.ajax({
		      ...
		      type : "GET",
		      async:false,
		      data : {"clientVO":clientVO},
		      // dataType : "json",
		      success : clientSelect,
  ...
  <section class="customer-list" style="overflow-y: scroll;">
    ...
    <div class="use_wrapper">
        <div class="btn" style="margin-top: 77px;">
            ...
            <div class="btn_search" style="padding:5px;margin-right:1000px"><a><i class="fa-solid fa-magnifying-glass"></i>&nbsp검색&nbsp</a> </div>
          </div>
...
<div class="use_wrapper">
    <div class="btn" style="margin-top: 77px;">
      ...
      <div style="float: right; margin-right: 10px;" >
        <a class="user_btn" style="padding:4px" ><i class="fa-solid fa-file-excel"></i>&nbsp승인</a>
        <a class="user_btn" style="padding:4px"><i class="fa-solid fa-file-excel"></i>&nbsp엑셀</a>
      </div>
    </div>
...
$('#customer_li').click(function clientSelect() { // 거래처관리
